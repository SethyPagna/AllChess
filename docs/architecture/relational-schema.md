...
| Scripts | Training, data, and operational helpers | `scripts/assets/*.ts`, `scripts/data/*.ts`, `scripts/ops/audit/*.ts`, `scripts/ops/deploy/*.ts`, `scripts/ops/maintenance/*.ts`, `scripts/training/*.ts` |
