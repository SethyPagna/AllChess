...
const en = {
  ...
  "nav.lobby": "Lobby",
  "nav.play": "Play",
  "nav.learn": "Games & rules",
  "nav.learnPractice": "Games & rules",
  "nav.practice": "Bot training",
  ...
  "variants.subtitle": "Choose a game family, learn the basics, then open verified boards.",
  ...
  "variant.chaturanga": "Chaturanga",
  "variant.crazyhouse": "Crazyhouse",
  "variant.shatranj": "Shatranj",
