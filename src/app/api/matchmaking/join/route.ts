...
export async function POST(request: Request) {
  ...
  const durable = await fetchDurableJson<{ ticket?: ReturnType<typeof createMatchmakingTicket>; match?: MatchmakingMatch; error?: string }>(env.MATCHMAKING_DO, "global-matchmaking", "/matchmaking/join", {
    method: "POST",
