...
4. Keep migrations in `ops/infra/cloudflare/d1/migrations` and schema docs in `ops/docs`.
...
- Future Python/Rust work should target `ops/scripts/training` or engine build tooling, not Next.js pages or Cloudflare request handlers.
