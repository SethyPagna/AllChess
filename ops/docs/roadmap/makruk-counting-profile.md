...
The subsequent [Quick Match pass](quick-match.md) routes casual matched games through the same protected room protocol, including honor-count actions. Rated play still needs verified accounts and rating settlement. Production deployment, remote persistence verification and tournament/referee certification are outside this pass. These limits remain visible in the rules atlas; the broad website goal remains active.
