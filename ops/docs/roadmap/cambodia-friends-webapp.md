...
1. Implement and validate Cambodia's explicit board-honor and piece-honor counting claims, cancellation/restart rules, counters, and terminal adjudication against championship references. Keep competitive/friend access gated until rules and bot validation are complete. Current rules reference: https://www.pychess.org/variants/cambodian and its linked championship document.
