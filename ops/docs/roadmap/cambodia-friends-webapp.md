...
- Classic chess and seven modern variants now have their own original ivory/walnut Blender collection. The shared 3D renderer offers real porcelain/slate materials, camera presets/reset, coordinates, move markers, promotion rings, and safe 2D recovery. Preferences remain specific to each game. See `ops/assets/classic/README.md`.
...
Latest 3D continuation: 376 unit/domain/API tests pass, including actual GLB structure/scale and camera-framing checks. Browser audits cover all nine enabled views, two camera presets, saved materials, rotation, castling, promotion, Crazyhouse drops, mobile layouts, failed model downloads, and WebGL context loss. Keyboard play remains in the 2D view.
...
2. Extend distinct 3D collections and camera/view choices to the other game families, keeping their authentic boards, pieces, and accessible 2D rendering. Cambodia and eight modern chess variants now have real 3D assets. Ancient, East Asian, Thai, draughts, and other families still need their own collections.
