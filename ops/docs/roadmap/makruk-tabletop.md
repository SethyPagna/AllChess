...
The subsequent rules pass implements versioned honor counting, claim controls, fixed piece limits, bot decisions, friend-room actions and cold offline count restoration. See [Makruk counting profile](makruk-counting-profile.md) for rules, compatibility and current validation. Ranked count actions and tournament/referee variations remain open; presentation work alone does not prove rule completeness.
