...
These are device-local records. Export/import, account synchronization, physical-device browser validation, and localization of the new controls remain separate acceptance gates. No production deployment is included.
