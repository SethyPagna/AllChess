...
The broader goal remains active. Native 3D now covers fourteen games, including Makruk. Physical Shogi hand stands and [Janggi opening formations](janggi-formations.md) are implemented. Additional tournament profiles, remaining regional collections, interface localization, account friend management, device PWA validation, save export/sync and guide-only engines remain open. No production deployment or remote migration is included.
