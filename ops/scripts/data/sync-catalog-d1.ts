...
const DEFAULT_CONFIG = "ops/infra/cloudflare/wrangler.jsonc";
...
async function main() {
  ...
  throw new Error("Use --print or --out with this Node generator. Use ops/scripts/data/sync-catalog-d1.ps1 for local or remote Wrangler execution on Windows.");
}
