...
The collection now uses the shared renderer with classic chess: material choices, an adjustable angled camera, reset view, small unboxed edge coordinates, promoted-piece rings, and direct recovery to 2D. The board has a solid bevelled wooden case, brass edging, a raised frame, feet, and a shadowed tabletop. This geometry and its lighting are created by the shared renderer. Its playing surface remains plain and its six native model identities are unchanged.
