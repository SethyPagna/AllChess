...
function allowedAsset(path) {
  ...
  return path === "/offline" || /^\/_next\/static\/[a-zA-Z0-9_./%~-]+\.(js|css|woff2?)$/.test(path)
    || ["/assets/khmer/collection.glb", "/assets/classic/collection.glb", "/engines/stockfish/stockfish-18-lite-single.js", "/engines/stockfish/stockfish-18-lite-single.wasm", "/icons/app-192.png", "/icons/app-512.png", "/icons/maskable-512.png", "/icon.svg"].includes(path);
}
